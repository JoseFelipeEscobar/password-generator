    ...
    <div className="text-options">
      <div className="slider-container">
        ...
        <Slider
          ...
          max={16}
          step={1}
          onChange={(value: number) => changeConfiguration("long", value)}
        >
          <SliderTrack>
            <SliderFilledTrack className="slider-option" />
          </SliderTrack>
          <SliderThumb className="ball-slide" boxSize={7} />
        </Slider>
      </div>
      ...
      <Stack spacing={5} direction="column">
        <Checkbox
          ...
          onChange={(event: ChangeEvent<HTMLInputElement>) =>
            console.log(changeConfiguration("letters", event.target.checked))
          }
        >
        ...
        <Checkbox
          ...
          onChange={(event: ChangeEvent<HTMLInputElement>) =>
            console.log(
              changeConfiguration("capitalLetters", event.target.checked)
            )
          }
        >
        ...
        <Checkbox
          ...
          defaultChecked
          onChange={(event: ChangeEvent<HTMLInputElement>) =>
            console.log(changeConfiguration("numbers", event.target.checked))
          }
        >
          <p>Include numbers</p>
        </Checkbox>
        <Checkbox
          ...
          defaultChecked
          onChange={(event: ChangeEvent<HTMLInputElement>) =>
            console.log(changeConfiguration("symbols", event.target.checked))
          }
        >
          <p>Include symbols</p>
        </Checkbox>
